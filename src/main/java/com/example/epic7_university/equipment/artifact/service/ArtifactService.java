...
import com.example.epic7_university.equipment.artifact.exception.ArtifactNotFoundException;
...
public class ArtifactService {
    ...
    public GetArtifactDetailResponse getArtifactDetail( Long id ) {
        Artifact artifact = artifactRepository.findById( id ).orElseThrow( ArtifactNotFoundException::new );
        return GetArtifactDetailResponse.of( artifact );
    }
}
